...
set ::env(KLAYOUT_DRC_RUNSET) "$::env(PDK_ROOT)/$::env(PDK)/libs.tech/drc/ics55_drc.drc"
# KLAYOUT_DRC_OPTIONS is set from the design config.yaml (env cannot carry a dict)
set ::env(KLAYOUT_LVS_SCRIPT) "$::env(PDK_ROOT)/$::env(PDK)/libs.tech/lvs/ics55.lvs"
