...
set ::env(WELLTAP_CELL) "FILLTAPH7H"
...
set ::env(SYNTH_DRIVING_CELL) "INVX8H7H/Y"
set ::env(OUTPUT_CAP_LOAD) 33.5
set ::env(SYNTH_BUFFER_CELL) "BUFX4H7H/A/Y"
set ::env(SYNTH_TIEHI_CELL) "TIEHIH7H/Z"
set ::env(SYNTH_TIELO_CELL) "TIELOH7H/Z"

# --- Fill / decap / tap cells (tech.yml: fills) ---------------------------------
# tech.yml gives regular expressions; LibreLane wants shell wildcards.
set ::env(DECAP_CELLS) [list "FILLCAP*H7H"]
set ::env(FILL_CELLS) [list "FILLER*H7H"]
...
set ::env(CELL_PAD_EXCLUDE) [list "FILLCAP*H7H" "TIEHIH7H" "TIELOH7H"]

# --- PDN -------------------------------------------------------------------------
set ::env(PDN_RAIL_WIDTH) 0.16

# --- Clock tree synthesis --------------------------------------------------------
set ::env(CTS_ROOT_BUFFER) "BUFX16H7H"
set ::env(CTS_CLK_BUFFERS) [list "BUFX4H7H" "BUFX8H7H" "BUFX16H7H"]
...
# Tri-state buffers exist in the library (TBUF*H7H) but were not part of the
# bring-up configuration; uncomment if needed.
# set ::env(TRISTATE_CELLS) [list "TBUF*H7H"]
